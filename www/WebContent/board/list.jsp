...
<div align="left">
	<br/>
	<h2 style="margin-left: 100px;">고객센터</h2>
	<br>
	<table align="center" border="0" width="80%">
			<tr>
				<td>Total : <%=totalRecord%> Articles(<font color="#7F7F7F">
			...
			<%
   				  ...
   				  if(totalPage !=0){
    			  	if (nowBlock > 1) {%>
     					...
     					<%if(pageStart==nowPage) {%><font color="#7F7F7F"> <%}%>
     					[<%=pageStart %>] 
				...
				<td align="right">
					<a href="post.jsp" onclick="return checkLogin()">[글쓰기]</a> 
